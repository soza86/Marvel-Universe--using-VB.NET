<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="CMCharacterPictures.aspx.vb" Inherits="MarvelUniverse.CMCharacterPictures" %>
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="ID" 
            ...
            <AlternatingItemTemplate>
                <td runat="server" style="background-color: #FFF8DC;">
                    <a href='ShowOneCMPicture.aspx?ID=<%# Eval("ID") %>' target="_blank">
            ...
            <EditItemTemplate>
                <td runat="server" style="background-color: #008A8C; color: #FFFFFF;">
                    ...
                    <br />CMCharacID:
                    <asp:TextBox ID="CMCharacIDTextBox" runat="server" 
                        Text='<%# Bind("CMCharacID") %>' />
                    <br />
...
<td runat="server" />
            ...
            <SelectedItemTemplate>
                <td runat="server" 
                    ...
                    <br />CMCharacID:
                    <asp:Label ID="CMCharacIDLabel" runat="server" 
                        Text='<%# Eval("CMCharacID") %>' />
                    <br />
                </td>
            </SelectedItemTemplate>
        </asp:ListView>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT DISTINCT [ID], [Picture], [FanName], [CMCharacID] FROM [CMCharactersPictures] WHERE ([CMCharacID] = ?)">
            <SelectParameters>
                <asp:QueryStringParameter Name="CMCharacID" QueryStringField="CMCharacID" 
                    Type="Int32" />
            </SelectParameters>
        </asp:SqlDataSource>
    </p>
